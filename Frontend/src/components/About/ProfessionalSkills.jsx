              ...
              <div className="h-28">
                <div
                  className="absolute -top-0 lg:top-[0%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9] bg-gray-800  duration-300 w-[90%] h-48 rounded-xl justify-items-center align-middle">
                    <DiReact className="w-36 h-36 text-white mt-6 m-auto"/>
                </div>
              </div>
          ...
          <div className="relative group h-48 flex   flex-col rounded-xl bg-clip-border text-gray-700 shadow-md">
            <a href="#" className="block">
              <div className="h-28">
                <div
                  className="absolute -top-0 lg:top-[0%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]  bg-gray-800 duration-300 w-[90%] h-48 rounded-xl justify-items-center align-middle">
                  <DiNodejs className="w-36 h-36 text-white mt-6 m-auto"/>
                </div>
              </div>
              <div className="p-6   z-10 w-full   ">
                <p
          ...
          <div className="relative group h-48 flex   flex-col rounded-xl bg-clip-border text-gray-700 shadow-md">
            <a href="#"
              ...
              <div className="h-28">
                <div
                  className="absolute -top-0 lg:top-[0%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9] bg-gray-800  duration-300 w-[90%] h-48 rounded-xl justify-items-center align-middle">
                  <DiMongodb className="w-36 h-36 text-white mt-6 m-auto"/>
                </div>
              </div>
              <div className="p-6   z-10 w-full   ">
                <p
          ...
          <div className="relative group h-48 flex   flex-col rounded-xl bg-clip-border text-gray-700 shadow-md">
            <a href="#"
              ...
              <div className="h-28">
                <div
                  className="absolute -top-0 lg:top-[0%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9] bg-gray-800  duration-300 w-[90%] h-48 rounded-xl justify-items-center align-middle">
                  <SiFirebase className="w-36 h-36 text-white mt-6 m-auto"/>
                </div>
              </div>
              <div className="p-6   z-10 w-full   ">
                <p
          ...
          <div className="relative group h-48 flex   flex-col rounded-xl bg-clip-border text-gray-700 shadow-md">
            <a href="#"
              ...
              <div className="h-28">
                <div
                  className="absolute -top-0 lg:top-[0%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9] bg-gray-800  duration-300 w-[90%] h-48 rounded-xl justify-items-center align-middle">
                    <CgCPlusPlus className="w-36 h-36 text-white mt-6 m-auto"/>
                </div>
              </div>
              <div className="p-6   z-10 w-full   ">
                <p
          ...
          <div className="relative group h-48 flex   flex-col rounded-xl bg-clip-border text-gray-700 shadow-md">
            <a href="#"
              ...
              <div className="h-28">
                <div
                  className="absolute -top-0 lg:top-[0%] left-[5%] z-40  group-hover:top-[-40%] group-hover:opacity-[0.9]  bg-gray-800 duration-300 w-[90%] h-48 rounded-xl justify-items-center align-middle">
                  <DiGit className="w-36 h-36 text-white mt-6 m-auto"/>
                </div>
              </div>
              <div className="p-6   z-10 w-full   ">
                <p
